...
⚡ Студент второго курса РТУ МИРЭА Института Искусственного Интеллекта учусь на направление: прикладная математика и информатика

📚 Начинающий Java backend developer

🏄‍♂️ Амбициозный человек с горящими глазами. Хоче развиваться сфере backend разработки

💼 Технологии и опты: написание android приложений на Java, со сброкой gradle/maven. Работа с бд, а именно Mysql и Postgresql. Есть небольшой опыт разработки на С/С++, QT.  

📫 Pet проект: [**Dumalka**](https://github.com/Delphington/Dumalka) - это универсальный помощник для викторин. Задача моего приложение находить вероятности правильного ответа на заданный вопрос Викторин c помощью интернета!
