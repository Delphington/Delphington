...
💼 Технологии и опыт: написание android приложений на Java, со сброкой gradle/maven. Работа с бд, а именно Mysql и Postgresql. Есть небольшой опыт разработки на С/С++, QT.  
