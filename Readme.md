...
👨‍🎓 **Образование:** студент второго курса РТУ МИРЭА, Института Искусственного Интеллекта. Направление: прикладная математика и информатика(ПМИ)

📚 **Область:** начинающий Java backend developer

👨‍💻 **Стек:** написание android приложений на Java, со сброкой gradle/maven. Работа с бд, SQLite и PostgreSQL. Есть небольшой опыт разработки на С/С++, QT  

🏄‍♂️ **Качества:** амбициозный человек с горящими глазами. Хочу развиваться сфере backend разработки. Готов к любым трудностям и задачам
