...
👨‍🎓 **Образование:** студент второго курса РТУ МИРЭА, Института Искусственного Интеллекта. Направление: прикладная математика и информатика

📚 **Направление:** начинающий Java backend developer
